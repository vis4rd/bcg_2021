...
class MyFrame1 : public wxFrame 
{
	...
	public:
		...
		MyFrame1( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("GFK Lab07 - Aleksander Kluczka"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 520,650 ), long style = wxDEFAULT_FRAME_STYLE|wxTAB_TRAVERSAL );
