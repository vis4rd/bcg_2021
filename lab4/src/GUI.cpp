...
MyFrame1::MyFrame1( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_staticText1 = new wxStaticText( this, wxID_ANY, wxT("Uklad Swiata"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	WxEdit_x0 = new wxTextCtrl( this, wxID_ANY, wxT("-1.0"), wxDefaultPosition, wxSize( 50,-1 ), 0 );
	...
	WxEdit_y0 = new wxTextCtrl( this, wxID_ANY, wxT("-2.0"), wxDefaultPosition, wxSize( 50,-1 ), 0 );
	...
	m_staticText7 = new wxStaticText( this, wxID_ANY, wxT("x1:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText7->Wrap( -1 );
	bSizer4->Add( m_staticText7, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	WxEdit_x1 = new wxTextCtrl( this, wxID_ANY, wxT("1.0"), wxDefaultPosition, wxSize( 50,-1 ), 0 );
	bSizer4->Add( WxEdit_x1, 0, wxALL, 5 );
	
	m_staticText8 = new wxStaticText( this, wxID_ANY, wxT("y1:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText8->Wrap( -1 );
	bSizer4->Add( m_staticText8, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	WxEdit_y1 = new wxTextCtrl( this, wxID_ANY, wxT("2.0"), wxDefaultPosition, wxSize( 50,-1 ), 0 );
	bSizer4->Add( WxEdit_y1, 0, wxALL, 5 );
	
	
	bSizer2->Add( bSizer4, 1, wxEXPAND, 5 );
	
	m_staticText9 = new wxStaticText( this, wxID_ANY, wxT("Obrot"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText10 = new wxStaticText( this, wxID_ANY, wxT("Alpha:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	WxStaticText_alpha = new wxStaticText( this, wxID_ANY, wxT("0"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	WxRB_Middle = new wxRadioButton( this, wxID_ANY, wxT("Srodek ekranu"), wxDefaultPosition, wxDefaultSize, 0 );
	WxRB_Middle->SetValue( true ); 
	bSizer2->Add( WxRB_Middle, 0, wxALIGN_CENTER|wxALL, 5 );
	
	WxRB_Center = new wxRadioButton( this, wxID_ANY, wxT("Srodek ukladu"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer2->Add( WxRB_Center, 0, wxALIGN_CENTER|wxALL, 5 );
	
	m_staticText81 = new wxStaticText( this, wxID_ANY, wxT("Translacja o wektor"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText91 = new wxStaticText( this, wxID_ANY, wxT("dX"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText91->Wrap( -1 );
	bSizer6->Add( m_staticText91, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	WxEdit_dX = new wxTextCtrl( this, wxID_ANY, wxT("0.0"), wxDefaultPosition, wxSize( 50,-1 ), 0 );
	bSizer6->Add( WxEdit_dX, 0, wxALL, 5 );
	
	m_staticText101 = new wxStaticText( this, wxID_ANY, wxT("dY"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText101->Wrap( -1 );
	bSizer6->Add( m_staticText101, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	WxEdit_dY = new wxTextCtrl( this, wxID_ANY, wxT("0.0"), wxDefaultPosition, wxSize( 50,-1 ), 0 );
	bSizer6->Add( WxEdit_dY, 0, wxALL, 5 );
	
	
	bSizer2->Add( bSizer6, 1, wxEXPAND, 5 );
	
	m_staticText11 = new wxStaticText( this, wxID_ANY, wxT("Wartosci na wykresie:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText12 = new wxStaticText( this, wxID_ANY, wxT("x_start"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText12->Wrap( -1 );
	bSizer7->Add( m_staticText12, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	WxEdit_x_start = new wxTextCtrl( this, wxID_ANY, wxT("-1.0"), wxDefaultPosition, wxSize( 50,-1 ), 0 );
	bSizer7->Add( WxEdit_x_start, 0, wxALL, 5 );
	
	m_staticText13 = new wxStaticText( this, wxID_ANY, wxT("x_stop"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText13->Wrap( -1 );
	bSizer7->Add( m_staticText13, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	WxEdit_x_stop = new wxTextCtrl( this, wxID_ANY, wxT("2.0"), wxDefaultPosition, wxSize( 50,-1 ), 0 );
	...
	m_staticText14 = new wxStaticText( this, wxID_ANY, wxT("y_min:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText14->Wrap( -1 );
	bSizer8->Add( m_staticText14, 0, wxALIGN_CENTER|wxALL, 5 );
	
	Ly_min = new wxStaticText( this, wxID_ANY, wxT("?"), wxDefaultPosition, wxDefaultSize, 0 );
	Ly_min->Wrap( -1 );
	bSizer8->Add( Ly_min, 0, wxALIGN_CENTER|wxALL, 5 );
	
	m_staticText16 = new wxStaticText( this, wxID_ANY, wxT("y_max:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText16->Wrap( -1 );
	bSizer8->Add( m_staticText16, 0, wxALIGN_CENTER|wxALL, 5 );
	
	Ly_max = new wxStaticText( this, wxID_ANY, wxT("?"), wxDefaultPosition, wxDefaultSize, 0 );
	Ly_max->Wrap( -1 );
	...
	wxString WxChoiceChoices[] = { wxT("x+sin(4x)"), wxT("x^2"), wxT("0.5*e^(4x-3x^2)") };
	...
	m_button1 = new wxButton( this, wxID_ANY, wxT("Do ukladu swiata"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer2->Add( m_button1, 0, wxALIGN_CENTER|wxALL, 5 );
	
	wxBoxSizer* bSizer9;
	bSizer9 = new wxBoxSizer( wxHORIZONTAL );
	
	m_button2 = new wxButton( this, wxID_ANY, wxT("Wczytaj"), wxDefaultPosition, wxDefaultSize, 0 );
