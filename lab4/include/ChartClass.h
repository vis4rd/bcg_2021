...
class ChartClass
{
    private:
        ...
        Matrix getRotationMatrix(int w, int h);
        Matrix getScaleMatrix(int w, int h);
        Matrix getTranslationMatrix();
        void drawText(wxDC *dc, Matrix transform, wxString text, double x, double y, int h);
        void drawAxes(wxDC *dc, Matrix transform, int w, int h);
        void transformLine(wxDC *dc, Matrix t, double x1, double y1, double x2, double y2, int w, int h);
