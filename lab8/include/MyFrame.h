...
class MyFrame : public wxFrame
{
	...
	public:
		...
		MyFrame( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = "GFK Lab08 - Aleksander Kluczka", const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize(1075, 572), long style = wxDEFAULT_FRAME_STYLE|wxTAB_TRAVERSAL );
